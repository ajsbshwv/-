...
print("用户界面库加载成功！")
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("小双")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
...
LOL:Label("脚本的创作者小双")
LOL:Label("123fa98通过白名单来保护小双脚本")
LOL:Label("小双脚本正在经历疯狂优化")
LOL:Label("小双脚本中心1群号813577857")
LOL:Label("小双脚本中心2群号")
LOL:Button(
    "复制到小双脚本①群号（如果找不到）",
    function()
...
LOL:Button(
    "复制到云脚本①链接（QQ可发送）",
    function()
        setclipboard("http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=YG0rJOGhwq7UDV2spnBI9n2ClhY-sSN3&authKey=qxbdZtt5RiitcqFLp0RGNpcOzQJ4Usd6ThfJb%2B%2BwspzO8H3PjSEbGvgk%2B3P0qXFl&noverify=0&group_code=813577857")
    end
)
----------------------------------------------------------------------------------------------------------------------------------------
